...
#-----------------------
cc = 0.0
pch1 = 18; cex1 = 0.3; col1 = "grey"
pch2 = 18; cex2 = 0.3; col2 = "grey"
pch1sey = 20; cex1sey = 1; col1sey = "orange2"
pch2sey = 20; cex2sey = 1; col2sey = "orange2"

#-----------------------
# OPEN FIGURE FILE
#-----------------------
pdf(output_file, width = 13, height = 6.5)
...
points(data$logN2Ha[xx.xxS_SF], data$logO3Hb[xx.xxS_SF], pch = 20, cex = 1, col = "deepskyblue2")
...
par(font = 2)
legend(-0.7, -1.2, 'Kauffmann+03', bty = 'n', text.col = 'grey30')
...
points(data$logN2Ha[xx.xxE_SF], data$logO3Hb[xx.xxE_SF], pch = 20, cex = 1, col = "deepskyblue2")
