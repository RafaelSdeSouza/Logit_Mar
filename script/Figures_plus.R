...
gRx_S<-read.table("..//data/gRxS_plus.dat",header=TRUE)
gRx_E<-read.table("..//data/gRxE_plus.dat",header=TRUE)
...
quartz.save(type = 'pdf', file = '..//figures/P_Rx_plus.pdf',width = 9.5, height = 9)
